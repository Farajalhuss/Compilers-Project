...
public class PLParser extends Parser {
	...
	public static final int
		...
		T__24=25, T__25=26, CONCAT=27, STRING=28, ID=29, NUMBER=30, WHITESPACE=31, 
		NEWLINE=32, LINE_COMMENT=33;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, null, "CONCAT", "STRING", "ID", "NUMBER", "WHITESPACE", "NEWLINE", 
			"LINE_COMMENT"
		};
	}
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 1963264768L) != 0) );
